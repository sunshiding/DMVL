...
def get_cifar10_dataloaders(data_folder, batch_size=128, num_workers=8, is_instance=False):
    """
    cifar 100
    """
...
def get_cifar10_dataloaders_sample(data_folder, batch_size=128, num_workers=8, k=4096, mode='exact',
